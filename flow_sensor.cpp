...
void readFlowRate() {
  ...
  if (average < calibration_curve_change_point) flow_rate = calibration_coeff_a1 * pow(average, 2) + calibration_coeff_b1 * average + calibration_coeff_c1;
  else flow_rate = calibration_coeff_a2 * pow(average, 2) + calibration_coeff_b2 * average + calibration_coeff_c2;
